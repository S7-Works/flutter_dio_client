...
class _$GeoTearOff {
  ...
  _Geo call({String lat = "0.0", String lng = "0.0"}) {
    return _Geo(
      lat: lat,
      lng: lng,
    );
...
class _$_Geo implements _Geo {
  const _$_Geo({this.lat = "0.0", this.lng = "0.0"});
...
class _$_User implements _User {
  ...
  @override
  String toString() {
    return 'User(name: $name, id: $id, username: $username, email: $email, status: $status, address: $address, phone: $phone, website: $website, company: $company)';
  }
